...
# 
# set.seed(2022)
# res_shc <- shc(patient_matrix, matmet=mfun, linkage="ward.D2", n_sim = 1000,alpha = .05)
# res_shc$hc_dat$labels <- rownames(patient_matrix)
# plot(res_shc,alpha=0.05,ci_emp=T,use_labs = TRUE)
# 
# referencia <- sigclust2::shcutree(res_shc,alpha = .05)
