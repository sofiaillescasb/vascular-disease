...
summary(res)
# 1935 DE genes, these are selected

# Add gene metadata (gene symbol) and fetch the table of results. Print first 15 DEgenes
rowRanges(se.filt)
...
with(tt, plot(logFC, -log10(adj.P.Val), pch = 20, main = "", xlim=c(-6,7), ylim=c(0,8))) 
...
par(xpd=T, mar=par()$mar+c(0,0,0,5))
with(tt, plot(logFC, -log10(adj.P.Val), pch = 20, main = "", xlim=c(-6,7), ylim=c(0,2))) 
